...
contacts_tab <- function(contact_sett) {
...
tab_cnt <- contacts_tab("n_cnt")
tab_cnt_home <- contacts_tab("n_cnt_home")
tab_cnt_work <- contacts_tab("n_cnt_work")
tab_cnt_school <- contacts_tab("n_cnt_school")
tab_cnt_other <- contacts_tab("n_cnt_other")

save_as_docx(tab_cnt, path = "outputs/tab_cnts.docx")
save_as_docx(tab_cnt_home, path = "outputs/tab_cnts_home.docx")
save_as_docx(tab_cnt_work, path = "outputs/tab_cnts_work.docx")
save_as_docx(tab_cnt_school, path = "outputs/tab_cnts_school.docx")
save_as_docx(tab_cnt_other, path = "outputs/tab_cnts_other.docx")
